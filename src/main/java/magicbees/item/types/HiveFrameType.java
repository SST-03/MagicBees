...
public enum HiveFrameType implements IBeeModifier {
    ...
    MAGIC("Magic", 240, 1f, 1f, 1f, 1.1f, 0.6f),// production was 2x, now +1.1 (slightly less nerfed than other frames due to being a pain)
    RESILIENT("Resilient", 800, 1f, 1f, 1f, 1.2f, 0.5f),// production was 2x, now +1.2
    GENTLE("Gentle", 200, 1f, 0.7f, 1.5f, 0.4f, 0.01f),// production was 1.4x, now +0.4
    METABOLIC("Metabolic", 130, 1f, 1.8f, 1f, 0.2f, 1f),// production was 1.2x, now +1.2
