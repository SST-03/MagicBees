...
public class BloodHelper implements IModHelper {
    ...
    public static void thaumRecipes() {
        /*
         * ThaumcraftHelper.bloodFrame = ThaumcraftApi.addArcaneCraftingRecipe( "MB_BloodFrame", new
         * ItemStack(Config.hiveFrameBlood), new AspectList().add(Aspect.AIR, 50).add(Aspect.FIRE, 50).add(Aspect.WATER,
         * 50).add(Aspect.EARTH, 50) .add(Aspect.ORDER, 50).add(Aspect.ENTROPY, 50), new Object[] { "sbs", "bFb", "sbs",
         * 's', ModItems.imbuedSlate, 'b', ModItems.bucketLife, 'F', Config.hiveFrameBloodBase });
         * ThaumcraftHelper.frenziedFrame = ThaumcraftApi.addArcaneCraftingRecipe( "MB_FrenziedFrame", new
         * ItemStack(Config.hiveFrameFrenzy), new AspectList().add(Aspect.AIR, 50).add(Aspect.FIRE,
         * 50).add(Aspect.WATER, 50).add(Aspect.EARTH, 50) .add(Aspect.ORDER, 50).add(Aspect.ENTROPY, 50), new Object[]
         * { "sns", "nFn", "sns", 's', ModItems.imbuedSlate, 'n', new ItemStack(ConfigItems.itemResource, 1, 1), 'F',
